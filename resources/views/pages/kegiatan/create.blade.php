<x-master-layout>
    ...
    <div class="page-header fade-up">
        <div class="ph-left">
            <h1><i class="bi bi-plus-circle-fill"></i> Tambah Kegiatan</h1>
            <p>Isi formulir berikut untuk mendokumentasikan kegiatan baru beserta foto-fotonya.</p>
        </div>
        <nav class="breadcrumb-nav">
            ...
            <span class="bc-sep"><i class="bi bi-chevron-right"></i></span>
            <span class="bc-current"><i class="bi bi-plus-circle-fill"></i> Tambah</span>
        </nav>
    </div>
    ...
    <form id="mainForm" novalidate onsubmit="return false;">
                ...
                <div class="form-card">
                    <div class="fc-head indigo">
                        <div>
                            ...
                            <div class="fc-desc">Isi data dasar dokumentasi kegiatan</div>
                        </div>
                    </div>
                    <div class="fc-body">
                        <!-- Judul -->
                        <div class="fgroup" id="grp-judul">
                            ...
                            <div class="fwrap">
                                ...
                                <input type="text" class="fctrl" id="f-judul" name="judul" placeholder="Contoh: Rapat Koordinasi Dinas Kominfo 2025" 
                                    oninput="charCount(this,'cc-judul',120);clearErr('grp-judul')" maxlength="120" required />
                            </div>
                            <div class="char-counter" id="cc-judul">0 / 120</div>
                        ...
                        <div class="fgroup">
                            ...
                            <div class="fwrap">
                                ...
                                <input type="text" class="fctrl" id="f-lokasi" name="lokasi" placeholder="Contoh: Ruang Rapat Lantai 3, Gedung A" />
                            </div>
                        </div>
                    ...
                    <div class="fc-body">
                        <div class="fgroup" id="grp-uraian">
                            ...
                            <div class="ck-editor-wrap" id="ck-wrap">
                                <textarea id="editor-uraian" name="uraian"></textarea>
                            </div>
                ...
                <div class="form-card">
                    ...
                    <div class="fc-body">
                        <div class="photo-upload-zone" id="uploadZone" onclick="document.getElementById('photoInput').click()">
                            ...
                            <div class="upload-title">Tarik foto ke sini atau klik untuk memilih</div>
                            ...
                            <div class="upload-formats">Pastikan foto dalam orientasi landscape untuk hasil terbaik</div>
                        </div>
            ...
            <aside class="form-right-col">
                ...
                <div class="side-card">
                    ...
                    <div class="sc-body">
                        ...
                        <div class="fhint" style="margin-top:12px; line-height: 1.4;">
                            Pilih status <strong>Selesai</strong> jika dokumentasi sudah lengkap dan siap dipublikasikan ke publik.
                        </div>
                    </div>
                </div>
                    ...
                    <div class="sc-body">
                        ...
                        <div class="fgroup" style="margin-bottom:0;">
                            ...
                            <div class="fwrap">
                                ...
                                <input type="text" class="fctrl" id="f-narasumber" name="narasumber" placeholder="Nama narasumber" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="side-card">
                    ...
                    <div class="sc-body">
                        <div class="photo-upload-zone" style="padding:18px 14px;" onclick="document.getElementById('docInput').click()">
                            ...
                            <div style="font-size:.8rem;font-weight:700;color:var(--c-text);margin-bottom:3px;text-align:center;">Upload Dokumen</div>
                            <div style="font-size:.72rem;color:var(--c-muted);text-align:center;">PDF, DOCX, XLSX, PPTX · Maks. 10 MB</div>
                        </div>
                ...
                <div class="side-card">
                    <div class="sc-head">
                        <div class="sc-title">
                            <i class="bi bi-lightbulb-fill" style="color:var(--c-accent);"></i> Tips Dokumentasi
                        </div>
                    </div>
                    <div class="sc-body">
                        <div class="tip-item">
                            <div class="tip-icon" style="background:var(--c-primary);"><i class="bi bi-camera"></i></div>
                            <div class="tip-text">Gunakan pencahayaan yang cukup saat mengambil foto di dalam ruangan.</div>
                        </div>
                        <div class="tip-item">
                            <div class="tip-icon" style="background:var(--c-green);"><i class="bi bi-card-text"></i></div>
                            <div class="tip-text">Uraian kegiatan sebaiknya mencakup <strong>5W + 1H</strong> (Apa, Siapa, Di mana, Kapan, Mengapa, Bagaimana).</div>
                        </div>
                        <div class="tip-item">
                            <div class="tip-icon" style="background:var(--c-accent);"><i class="bi bi-image"></i></div>
                            <div class="tip-text">Urutan foto pertama akan otomatis menjadi <strong>Cover Utama</strong>.</div>
                        </div>
                    </div>
                </div>
            </aside>
        ...
        <div class="form-actions-bar fade-up">
            ...
            <div style="margin-left:auto; display:flex; gap:10px;">
                <button type="button" class="btn-draft" onclick="submitForm(true)">
                    <i class="bi bi-file-earmark-text"></i> Simpan Draf
                </button>
                <button type="button" class="btn-submit" onclick="submitForm(false)">
                    <i class="bi bi-send-fill"></i> Publikasikan Dokumentasi
                </button>
            </div>
        </div>
    </form>

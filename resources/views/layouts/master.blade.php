...
<head>
    ...
    <meta name="description" content="Sistem Informasi DokaKegiatan — Platform manajemen kegiatan dan dokumentasi instansi yang efisien dan terintegrasi.">
    <meta name="author" content="DokaKegiatan Team">
    <title>{{ $title ?? 'DokaKegiatan — Dashboard' }}</title>
